package jenkinsci.plugins.rc.influxdb.generators;
...
public class CustomDataPointGenerator extends AbstractPointGenerator {
    ...
    public CustomDataPointGenerator(Run<?, ?> build, TaskListener listener,
        ...
        this.measurementName = InfluxDbStoreStep.DEFAULT_MEASUREMENT_NAME.equals(measurementName) ? "jenkins_custom_data" : "custom_" + measurementName;
    }
